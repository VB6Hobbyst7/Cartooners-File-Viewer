...
Public Class MusicClass
   ...
   Private Sub DisplayDataMenu_Click(sender As Object, e As EventArgs) Handles DisplayDataMenu.Click
      Try
         Dim MIDITrackOffset As Integer = GetLEWord(DataFile().Data, LocationsE.MIDITrackOffset)
         ...
         With New StringBuilder
            ...
            .Append($"{NewLine}{NewLine}-PC-Speaker pitch and speed: {GetLEWord(DataFile().Data, LocationsE.PCSpeakerPitchAndSpeed):X}")
   ...
   Private Sub DisplayInformationMenu_Click(sender As Object, e As EventArgs) Handles DisplayInformationMenu.Click
      Try
         With New StringBuilder
            ...
            .Append($"-Midi track offset: {GetLEWord(DataFile().Data, LocationsE.MIDITrackOffset)} byte(s).{NewLine}")
